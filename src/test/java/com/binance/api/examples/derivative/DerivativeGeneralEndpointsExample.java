...
import com.binance.api.client.derivative.DerivativeSymbolInfo;
 ...
 * @Ttron May 31, 2024
 */
public class DerivativeGeneralEndpointsExample extends ExampleBase
{
	public static void main(String[] args)
	{
		...
		// Exchange info
		DerivativeExchangeInfo exchangeInfo = client.getExchangeInfo();
		...
		DerivativeSymbolInfo symbolInfo = exchangeInfo.getSymbolInfo( "BTCUSDT" );
		...
		List<DerivativeSymbolInfo> symbolList = exchangeInfo.getSymbols();
		for ( int i = 0; i < symbolList.size(); i++ )
		{
			DerivativeSymbolInfo symbol = symbolList.get( i );
