...
import cn.ttron.billions.cryptocurrency.CryptocurrencyOrder;
...
public class BinanceOrder extends CryptocurrencyOrder
{
	@Override
	public String toString()
	{
		...
		return "BinanceOrder [currencyPair=" + (getCurrencyPair() != null ? getCurrencyPair().getCode() : "null")
				...
				+ (getDirectionId() == 0 ? ", sell " : ", buy ") + getAmount() + " @ " + getPrice() + "]";
	}
}
